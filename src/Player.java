...
public class Player  {
    ...
    public void move(int[] walls_x_pos,int[] walls_y_pos,int wall_lenght) {
        if (leftDirection) {
            player_x -= 1;
        }    
        ...
        player_jump( walls_x_pos, walls_y_pos, wall_lenght);
        
    }

    public void player_jump(int[] walls_x_pos,int[] walls_y_pos,int wall_lenght ){
    ...
    int portal1_x,int portal1_y,int portal2_x,int portal2_y) {
